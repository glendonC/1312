  ...
  return [
    ...
    ...(generalized ? [
      ...
      ...(restudied ? [
        ...
        ...(researchEnabled ? ["study_research_request is available only for an exact host-derived unresolved study conflict. Copy its inputId and triggerId exactly. The host mints the research grant, fixes the gap binding, domain allowlist, budgets, and the child contract. Search snippets are routing hints and never citations; receipted document spans are cite-only external context. Research never becomes claim support, caption text, transcript authority, or truth."] : []),
