...
| 11. Publish output | Timed source, translation, withheld lines, captions, study, evidence, exports | Recorded captions, comparison, scores, evidence, glossary, and artifact links render. Production can now record only queued/rejected review intake over a verified decision; no review, caption, upload, or publication consumer exists | A+B / recorded replay plus real local review-intake lineage; production review and publication missing | Add a human review producer over queued intake before any separately authorized caption/publish producer |
...
- Treat publish-review `queued` as reviewed, captioned, uploaded, published, or public; it is only
  durable intake lineage awaiting a future human review producer
