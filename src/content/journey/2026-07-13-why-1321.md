...
1321 is being built to take a public video or owned clip, let specialized workers inspect the source in parallel, and produce timed Korean, checked English, and the difficult lines worth learning. When the evidence is weak, it should expose the gap instead of polishing a fluent mistake.
