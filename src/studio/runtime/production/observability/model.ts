...
export interface ObservabilityReceiptSource {
  receiptId: string;
  kind: "media_operation" | "semantic_media_evidence" | "evidence_assessment" | "evidence_decision" | "publish_review_intake" | "publish_review_decision" | "publish_review_revocation" | "caption_production" | "caption_quality_control" | "root_output_disposition" | "executor_span" | "model_usage";
  eventId: string;
  contentId: string;
