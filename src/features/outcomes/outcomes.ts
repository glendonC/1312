...
export const hero = {
  title: "Outcomes",
  standfirst:
    "What understanding real media unlocks, for the systems that produce the understanding and the people who learn from it.",
};
...
export const sections: OutcomeSection[] = [
  {
    ...
    index: "01",
    palette: "teal",
    title: "Understands the lines other tools miss",
    body: [
  ...
  },
  {
    ...
    index: "02",
    palette: "coral",
    title: "Catches errors by re-checking the source",
    body: [
  ...
  },
  {
    ...
    index: "03",
    palette: "citron",
    title: "Puts effort only where the media is hard",
    body: [
  ...
  },
  {
    ...
    index: "05",
    palette: "lilac",
    title: "Do the work once, reuse it everywhere",
    body: [
  ...
  },
  {
    ...
    index: "06",
    palette: "peach",
    title: "Turns understanding into a way to learn",
    body: [
